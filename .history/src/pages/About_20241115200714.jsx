...
const Image = styled.div`
  ...
  @keyframes changeImage {
    0% {
      background-image: url(${GithubIcon}); /* Hình ảnh đầu tiên */
    }
    33% {
      background-image: url("https://via.placeholder.com/300"); /* Hình ảnh thứ hai */
    }
    66% {
      background-image: url("https://via.placeholder.com/301"); /* Hình ảnh thứ ba */
    }
    100% {
      background-image: url(${GithubIcon}); /* Quay lại hình ảnh đầu tiên */
    }
  }
`;
