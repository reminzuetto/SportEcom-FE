...
const Image = styled.div`
  width: 100%;
  height: 100%;
  background-image: "/src/assets/anh1.jpg"; /* Hình ảnh mặc định */
  ...
  @keyframes changeImage {
    0% {
      background-image: "/src/assets/anh1.jpg";
    }
    33% {
      background-image: "/src/assets/anh2.jpg";
    }
    66% {
      background-image: "/src/assets/anh3.jpg";
    }
    100% {
      background-image: "/src/assets/anh1.jpg";
    }
